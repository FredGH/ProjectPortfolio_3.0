...
CREATE OR REPLACE PROCEDURE CSTA_MARKETING_SHARED.OBSERVABILITY.LOG_CORTEX_USAGE(
    run_id         VARCHAR,
    env            VARCHAR,
...
GRANT USAGE ON PROCEDURE CSTA_MARKETING_SHARED.OBSERVABILITY.LOG_CORTEX_USAGE(
