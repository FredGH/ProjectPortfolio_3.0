...
VENUES: list[dict] = [
    ...
    {
        "venue_id": "BLTX",
        "name": "Bloomberg Fixed Income",
        "country": "US",
        "type": "OTC",
    },
    {
        "venue_id": "MFTR",
        "name": "MarketFinancials Trading",
        "country": "GB",
        "type": "OTC",
    },
...
COUNTERPARTY_DETAILS: list[dict] = [
    ...
    },
    {
        ...
        "name": "European Fund Management SA",
        "type": "ASSET_MANAGER",
        "country": "FR",
        "lei": "969500H9GB1Z9ME9VT63",
    },
    {
        "counterparty_id": "CP_IJKL",
        "name": "Nordic Institutional Investors AB",
        "type": "PENSION_FUND",
        "country": "SE",
        "lei": "529900BKTH5P99BTST43",
    },
    {
        "counterparty_id": "CP_MNOP",
        "name": "Milan Asset Partners SpA",
        "type": "HEDGE_FUND",
        "country": "IT",
        "lei": "815600C0BAE5D9D5A627",
    },
    {
        "counterparty_id": "CP_QRST",
        "name": "Dublin Insurance Asset Management",
        "type": "INSURANCE",
        "country": "IE",
        "lei": "635400YSC9E9BXHP6Y40",
    },
]
...
LEGAL_ENTITIES: list[dict] = [
    {
        "entity_id": "PB_DE",
        "name": "PrivateBank Bank Hamburg",
        "jurisdiction": "DE",
        "mifid_lei": "DGKL00HFI22345678901",
    },
    {
        "entity_id": "PB_UK",
        "name": "PrivateBank Capital Markets LLC UK",
        "jurisdiction": "GB",
        "mifid_lei": "DGKL00HFI22345678902",
    },
    {
        "entity_id": "BCM_US",
        "name": "PrivateBank Capital Markets LLC",
        "jurisdiction": "US",
        "mifid_lei": "DGKL00HFI22345678903",
    },
]
        ...
        instruments.append(
            {
                ...
                "sector": fake.random_element(
                    ["Financials", "Healthcare", "Industrials", "Energy", "Technology"]
                ),
                "country_of_risk": fake.random_element(
                    ["DE", "GB", "FR", "NL", "IT", "ES", "SE"]
                ),
        ...
        instruments.append(
            {
                ...
                "coupon_rate": round(
                    float(
                        Faker().random_element([1.5, 1.75, 2.0, 2.35, 2.5, 3.0, 3.15])
                    ),
                    4,
                ),
                "maturity_date": fake.date_between(
                    start_date="+3y", end_date="+10y"
                ).isoformat(),
                "sector": "Government",
                "country_of_risk": fake.random_element(
                    ["DE", "FR", "IT", "ES", "GB", "NL", "BE"]
                ),
                "_loaded_at": loaded_at,
            }
        )
        ...
        traders.append(
            {
                ...
                "name": fake.name(),
                "desk": fake.random_element(
                    ["Equity Execution", "Rates", "FX", "Derivatives"]
                ),
...
def ref_data_source() -> Iterator:
    ...
    @dlt.resource(
        name="instruments", write_disposition="merge", primary_key="instrument_id"
    )
    def instruments() -> Iterator[dict]:
        yield from _make_instruments()

    @dlt.resource(
        name="clients", write_disposition="merge", primary_key="counterparty_id"
    )
    ...
    @dlt.resource(
        name="legal_entities", write_disposition="merge", primary_key="entity_id"
    )
