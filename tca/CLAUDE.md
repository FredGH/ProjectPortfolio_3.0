...
2. Implement changes following the rules in `.claude/rules/` (see Rules table above)
3. Run `dbt build` and/or `coverage run -m unittest discover` as relevant before committing
