...
{{
  ...
  "publications": [{{"citation": "<full citation text, verbatim>", "authors": ["<author name>", ...], "conference": "<conference or journal name, or null>", "year": <YYYY or null>}}, ...],
...
- "authors" is the citation's author list, split into separate names (e.g. "Smith J., Doe A. & Lee K." becomes ["Smith J.", "Doe A.", "Lee K."]). "conference" is the conference, journal, or publisher name mentioned alongside the citation (e.g. "10th Int. Conference on Computational Collective Intelligence Sciences, Springer"), kept separate from "citation" rather than folded into it. "year" is the publication year if stated, else null.
